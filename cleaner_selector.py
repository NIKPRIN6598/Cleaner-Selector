...
if criteria_applied and applied_filters_count < 3:
    filtered_df = pd.DataFrame()  # Display empty DataFrame if less than 3 criteria
...
if filtered_df.empty:
    st.write("Please select at least 3 filter criteria.")
else:
